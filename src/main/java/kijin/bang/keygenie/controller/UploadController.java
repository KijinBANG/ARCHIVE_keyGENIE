...
import kijin.bang.keygenie.dto.UploadResultDTO;
...
public class UploadController {
    ...
    @Value("${kijin.bang.keygenie.upload.path}") // application.properties 변수
    ...
    @PostMapping(value = "/spring/uploadajax")
