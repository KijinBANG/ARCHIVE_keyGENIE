...
import kijin.bang.keygenie.dto.GuestBookDTO;
import kijin.bang.keygenie.dto.PageRequestDTO;
import kijin.bang.keygenie.dto.PageResponseDTO;
import kijin.bang.keygenie.service.GuestBookService;
...
@RequestMapping("/spring/guestbook")
...
//    }
    ...
    public String register(GuestBookDTO dto, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute(
                "msg", gno + " 삽입");
        //작업 후 목록보기로 리다이렉트
        return "redirect:/spring/guestbook/list";
    }
...
//    }
    ...
    public String modify(GuestBookDTO dto, @ModelAttribute("requestDTO") PageRequestDTO requestDTO, RedirectAttributes redirectAttributes){
        ...
        return "redirect:/spring/guestbook/read";
    }
