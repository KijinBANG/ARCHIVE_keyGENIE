...
import kijin.bang.keygenie.entity.QBoard;
import kijin.bang.keygenie.entity.QMember;
import kijin.bang.keygenie.entity.QReply;
...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository {
    ...
    public Page<Object[]> searchPage(String type, String keyword, Pageable pageable) {
        ...
        //Board 와 Member.email 그리고 Reply 의 count를 가져오는
        //쿼리를 생성
        ...
        sort.stream().forEach(order -> {
            ...
            tuple.orderBy(new OrderSpecifier(
                    direction, orderByExpression.get(prop)));
        });
